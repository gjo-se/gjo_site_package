...
class LoginSiteTest extends AbstractSiteTest
{
    /**
     * @test
     *
     ...
     */
    public function feUserIsNotLoggedIn_loginLogsin_and_redirectsToHome_Test($lang, $path, $targetPath)
    {
    ...
    {
        return array(
            'de/login' => ['de', 'login', 'targetPagePath' => ''],
            'en/login' => ['en', 'login', 'targetPagePath' => ''],
        );
    }
